...
public class Read_XLS {
	...
	public Read_XLS(String filelocation){		
		...
		try {
			System.out.println("Excel FilePath: "+filelocation);
	...
	public String retrieveToRunFlag(String wsName, String colName, String rowName){
		...
		System.out.println("Worksheet_name: "+wsName + " column_name: "+colName + " rowName: "+rowName);
		int sheetIndex=wb.getSheetIndex(wsName);
	...
	public boolean writeResult(String wsName, String colName, String rowName, String Result){
		try{
			...
			System.out.println("*********Check the following: ***********\n1.Sheetname :"+wsName+"\n2.Column Name:"+colName+"\n3.Testcase_name:"+rowName);
			e.printStackTrace();
			return false;
		}
		return true;
